...
public class EnquiryController {
    ...
    private static final String ENQUIRY_NOT_FOUND = "Enquiry not found";

	@GetMapping("/health")
	public String enquiry() {
		return "contoso enquiry svc is up and running!";
	}
    ...
    public EnquiryResponseDetails getEnquiryById(@RequestParam String enquiryId) {
        Enquiry enquiry = enquiryRepository.findByEnquiryId(enquiryId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, ENQUIRY_NOT_FOUND + ": " + enquiryId));
    ...
    public List<Enquiry> searchEnquiries(
        ...
        if (enquiries == null || enquiries.isEmpty()) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, ENQUIRY_NOT_FOUND);
        }
